...
Set @filenames='E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\1C_Prod_Portfolio_Replication_Tables_List.csv;E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\EDS_Prod_Replication_Tables_List.csv'
...
  @subject = 'Automated Mailer: Prod Replication Tables List || EDS Prod || 1C Prod Portfolio Servers',
  @body = '<html><body style="font-family:serif;">Hi Team,<br><br>Please find the latest <b>EDS Prod to PAAS Master</b> and <b>PAAS Master to 1C Prod porfolio Servers Replication Tables List</b>.<br><br>Note : If you require the most up-to-date Prod Replication tables List for analysis or reference, please utilize the attached file.</br><br>Regards,<br><b>ITOps 1C-EDM DBA Team<b></body></html>',
    @body_format = 'HTML',
