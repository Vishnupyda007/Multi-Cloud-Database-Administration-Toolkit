...
/****** Object:  StoredProcedure [dbo].[USP_ProdReplication_Tables_List]    Script Date: 7/4/2025 12:17:00 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[USP_ProdReplication_Tables_List] with Encryption
...
SET @sql = 'bcp "SELECT * FROM [1CDBAMonitoring].[dbo].[vw_ProdReplicationTablesList_WithHeaders]" queryout "E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\1C_Prod_Portfolio_Replication_Tables_List.csv" -c -t, -T -S CTSINAZSIPDDB06';


SET @sql1 = 'bcp "SELECT * FROM [1CDBAMonitoring].[dbo].[vw_EDS_ProdReplicationTablesList_WithHeaders]" queryout "E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\EDS_Prod_Replication_Tables_List.csv" -c -t, -T -S CTSINAZSIPDDB06';
...
Set @filenames='E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\EDS_Prod_Replication_Tables_List.csv;E:\1CDBA_Data_Donot_Delete\Prod_Replication_Tables_List\1C_Prod_Portfolio_Replication_Tables_List.csv'
...
  @subject = 'Reminder: Prod Replication Tables List || EDS Prod || 1C Prod Portfolio Servers',
  @body = '<html><body style="font-family:serif;">Hi Team,<br><br>Please find the latest list of Prod Replication Tables for <b>EDS Prod to PAAS Master, EDS Prod to 1C Prod Portfolio Servers</b> and <b>PAAS Master to 1C Prod porfolio Servers</b>.<br><br>Note : If you require the most up-to-date Prod Replication tables List for analysis or reference, please utilize the attached file.</br><br>Regards,<br><b>ITOps 1C-EDM DBA Team<b></body></html>',
    @body_format = 'HTML',
