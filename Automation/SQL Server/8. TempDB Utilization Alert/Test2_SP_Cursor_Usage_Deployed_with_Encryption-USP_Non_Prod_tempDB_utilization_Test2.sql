...
CREATE PROCEDURE [dbo].[USP_Non_Prod_tempDB_utilization_Test2]
WITH ENCRYPTION
...
BEGIN
    ...
    DECLARE @servers TABLE (Servername NVARCHAR(200));
    ...
    BEGIN
        ...
        BEGIN
            ...
            N'<th style="background:#87ceeb">Free Log Space Size(MB)</th>' +
            N'</tr></font>' +
            ...
            WHERE Servername = @servername AND [Total_TempDB_Size(GB)] > 80) AS subquery
    ...
    BEGIN
		...
		balakrishna.mannepalli@cognizant.com',    
