...
/****** Object:  StoredProcedure [dbo].[MI_SIT_Servers_Weekly_Maintenance_Jobs_Status_Report]    Script Date: 11/12/2024 11:47:59 PM ******/
SET ANSI_NULLS ON
GO
...
/***** Object:  StoredProcedure [dbo].[MI_SIT_Servers_Weekly_Maintenance_Jobs_Status_Report]    Script Date: 11-11-2024 2.10.03 PM ******/     
-- =============================================    
-- Author:  <Author,,Name>    
-- Create date: <Create Date,,>    
-- Description: <Description,,>    
------ =============================================    
CREATE PROCEDURE [dbo].[MI_SIT_Servers_Weekly_Maintenance_Jobs_Status_Report]    
...
INSERT INTO #temp select * from MI_SIT_Servers_Weekly_Maintenance_Jobs_Status     
...
<p>   
Hi Team,   
<br>Please find the below SIT Servers Bi-Weekly Maintenance jobs Status Report.<br>   
<br> <br>  
</p>  
<style>
...
'SELECT @html =  @html + '<tr style="color:'+case when [Job_Enable_Status] = 'Disabled' then 'orange' when [Job_LastRun_Status] = 'Failed' then 'red' else 'black' end +';"><td style="text-align: Center;">'  
...
FROM #temp order by [Job_Enable_Status], [Job_LastRun_Status] asc    
...
@profile_name='CRS',    
@recipients = 'ashwathi.k@cognizant.com',
@body = @html,    
@body_format ='HTML',    
@subject = 'Test- Bi Weekly SIT Servers Maintenance Jobs Status Report' ;    
