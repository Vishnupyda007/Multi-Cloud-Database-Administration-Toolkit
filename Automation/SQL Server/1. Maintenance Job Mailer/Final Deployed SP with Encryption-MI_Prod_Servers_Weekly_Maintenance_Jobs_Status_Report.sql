...
/****** Object:  StoredProcedure [dbo].[MI_Prod_Servers_Weekly_Maintenance_Jobs_Status_Report]    Script Date: 2/12/2025 12:05:55 PM ******/
SET ANSI_NULLS ON
GO
...
<p>   
Hi Team,   
<br>Please find the below Production MI Servers Weekly Maintenance jobs Status Report.<br>   
<br>Note: PGN, PFD and EDS Prod Servers have exceeded the Job history limit. Hence connect to the servers and check the job status Manually.<br> 
<br> 
</p>  
<style>
        table, th, td {    
...
@body = @html,    
@body_format ='HTML',    
@subject = 'Weekly Prod MI Maintenance Jobs Status Report' ;    
