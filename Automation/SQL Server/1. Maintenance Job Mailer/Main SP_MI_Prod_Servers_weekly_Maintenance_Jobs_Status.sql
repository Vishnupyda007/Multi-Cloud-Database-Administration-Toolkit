...
/****** Object:  StoredProcedure [dbo].[MI_Prod_Servers_Weekly_Maintenance_Jobs_Status_Report]    Script Date: 11/15/2024 11:54:25 AM ******/
SET ANSI_NULLS ON
GO
...
@profile_name='CRS',    
@recipients='CRSDBASUPPORT@cognizant.com',--@recipients ='person1@email.com;person2@email.com;person3@email.com',    
@body = @html,    
@body_format ='HTML',    
@subject = 'Bi Weekly Prod MI Maintenance Jobs Status Report' ;    
