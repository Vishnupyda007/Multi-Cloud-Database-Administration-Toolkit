...
SELECT @sql37 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_43076]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_43076.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql38 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_4533]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_4533.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql39 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_BCApps1]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_BCApps1.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql40 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_BCApps2]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_BCApps2.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql41 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_BCApps3]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_BCApps3.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql42 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_DE1]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_DE1.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql43 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_MC1]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_MC1.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql44 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_NC1]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_NC1.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql45 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_NC2]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_NC2.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql46 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PFD]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PFD.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql47 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PGN]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PGN.csv"  -w -T -S CTSINAZSIPDDB06'
		   
SELECT @sql48 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PPLT]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PPLT.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql49 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PRDML01]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PRDML01.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql50 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PST]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PST.csv"  -w -T -S CTSINAZSIPDDB06'

SELECT @sql51 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PTM]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PTM.csv" -w -T -S CTSINAZSIPDDB06'

SELECT @sql52 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_PTM1]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_PTM1.csv" -w -T -S CTSINAZSIPDDB06'

SELECT @sql53 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_R1Cloud]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_R1Cloud.csv" -w -T -S CTSINAZSIPDDB06'

SELECT @sql54 = 'bcp "select Table_Name, REPLACE(REPLACE(REPLACE(Index_Details, CHAR(9), '' ''), CHAR(13), '' ''), CHAR(10), '' '') FROM [1CDBAMonitoring].[dbo].[vw_DRMI_Index_Tbl_4582]" queryout "E:\1CDBA_Data_Donot_Delete\1C_Prod_DR_User_Access_Indexes_Backup\Indexes\Indexes_DDLs_4582.csv" -w -T -S CTSINAZSIPDDB06'
...
<html>
  <body style="font-family:serif;">
   ...
   <table border="1" style="border-collapse: collapse; font-family: serif; width: 100%; font-size: 10.5pt;">
    <thead>
    <tr style="background: #87ceeb;">
      <th style="border: 1px solid black; padding: 6px 10px; text-align: center; width: 70%;"><strong>Server Name</strong></th>
      <th style="border: 1px solid black; padding: 6px 10px; text-align: center; width: 30%;"><strong>Database Name</strong></th>
    </tr>
    </thead>
      <tbody>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimibcapps1.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimibcapps2.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazmibcapps3.293366d454bb.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimipst.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimipplt.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimiptm.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimipfd.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimipgn.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazpdmincapps1.b96303a221dc.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazpdmincapps2.b96303a221dc.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimipddeapps1.293366d454bb.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CTSAZSIMIPRDML01.293366D454BB.DATABASE.WINDOWS.NET</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimiptm1.293366d454bb.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazsimimcapps1.293366d454bb.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">ctsazmipdpcrsr1.inso1a101c37461fa.database.windows.net</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository_Report</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CPCINCHPV004582</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CPCINCHPV004533</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
        <tr>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CAZINSIPV143076</td>
          <td style="border: 1px solid black; padding: 5px 10px; text-align: center;">CentralRepository</td>
        </tr>
      </tbody>
    </table>
