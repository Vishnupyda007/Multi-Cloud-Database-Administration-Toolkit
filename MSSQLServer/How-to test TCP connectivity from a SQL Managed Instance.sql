--START
-- Parameters
DECLARE @endpoint NVARCHAR(512) = N'ctssqlmiprod.blob.core.windows.net'
DECLARE @port NVARCHAR(5) = N'443'
 
--Script
DECLARE @jobName NVARCHAR(512) = N'TestTCPNetworkConnection7', @jobId BINARY(16), @cmd NVARCHAR(MAX)
...
EXEC msdb.dbo.sp_add_jobserver @job_name = 'TestTCPNetworkConnection7'
 
 
 
 
----Step2
EXEC msdb.dbo.sp_start_job @job_name='TestTCPNetworkConnection7'
...
WHERE J.name='TestTCPNetworkConnection7' and step_id = 0
